...
### 점근표기법 : 어떤 함수의 증가 양상을 다른 함수와의 비교로 표현하는 수론과 해석학의 방법이다. 알고리즘의 복잡도를 단순화할 때나 무한급수의 뒷부분을 간소화할 때 쓰인다.
알고리즘을 분석할 때 최선, 평균, 최악의 경우가 있다.
...
- 최악: 빅오표기법(데이터 수의 증가에 따른 연산횟수 증가율의 상한선을 표현한 것)
```
